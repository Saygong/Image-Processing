...
ip_mat* ip_mat_create(unsigned int h, unsigned int w, unsigned  int k, float v) {
    ...
    /*Controllo che le allocazioni siano andate a buon fine*/
    matt = (ip_mat*)malloc(sizeof(ip_mat)); 
    if(matt==NULL)
        exit(1);
    ...
    statistiche = (stats*)malloc(k * sizeof(stats));
    if(statistiche==NULL)
        exit(1);
...
void compute_stats(ip_mat* t)
{
    if(t!=NULL){
        ...
        printf("Errore input compute_stats!!!\n");
        exit(1);
    }
}
...
void ip_mat_init_random(ip_mat* t, float mean, float std)
{
    if(t!=NULL){
        ...
        printf("Errore input ip_mat_init_random!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_copy(ip_mat* in) {
    if(in!= NULL){
        ...
        printf("Errore input ip_mat_copy!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_subset(ip_mat* t, unsigned int row_start, unsigned int row_end, unsigned int col_start, unsigned int col_end) {
    if(t!=NULL){
        ...
        printf("Errore input ip_mat_subset!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_concat(ip_mat* a, ip_mat* b, int dimensione) {
    if(a != NULL && b!= NULL){
        ...
        printf("Errore input ip_mat_concat!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_sum(ip_mat* a, ip_mat* b) {
    if(a!=NULL && b!=NULL){
        ...
        printf("Errore input ip_mat_sum!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_sub(ip_mat* a, ip_mat* b) {
    if(a!=NULL && b!=NULL){
        ...
        printf("Errore input ip_mat_sub!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_mul_scalar(ip_mat* a, float c) {
    if(a!=NULL){
        ...
        printf("Errore input ip_mat_mul_scalar!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_add_scalar(ip_mat* a, float c) {
    if(a!=NULL){
        ...
        printf("Errore input ip_mat_add_scalar!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_to_gray_scale(ip_mat* in) {
    if(in != NULL){
        ...
        printf("Errore input ip_mat_gray_scale!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_blend(ip_mat* a, ip_mat* b, float alpha) {
    if (a!=NULL && b!= NULL && a->h == b->h && a->w == b->w && a->k == b->k && alpha <= 1.0 && alpha >= 0.0)
    {
        ip_mat* alpha1;
        ip_mat* alpha2;
        ip_mat* blends;
...
ip_mat* ip_mat_brighten(ip_mat* a, float bright)
{
    if(a!=NULL){
        ...
        printf("Errore input ip_mat_brighten!!!\n");
        exit(1);
    }
}
...
ip_mat* ip_mat_corrupt(ip_mat* a, float amount) {
    if (a!=NULL && amount >= 0.0 && amount <= 255) {
        ip_mat* corrupted;
        ip_mat* temp;
        temp = ip_mat_copy(a); /*i valori di a verrano in seguito sostituiti*/  

        /*Con std = 1/3 amount, abbiamo il 99.73% di generare numeri 
        * compresi tra [-amount, +amount],
        * in quanto amount = 3 std*/
        ip_mat_init_random(temp, 0, (amount/2));
        ...
        for (k = 0; k < a->k; k++)
        {
            ...
            for (i = 0; i < padded->h - (pad_h * 2); i++)
            {
                for (j = 0; j < padded->w - (pad_w * 2); j++)
                {
                    float result = 0.0;
                    ip_mat* tmp;
                    tmp = ip_mat_subset(padded, i, i + f->h, j, j + f->w);
                    ...
                    for (ii = 0; ii < f->h; ii++)
                    {
                        for (jj = 0; jj < f->w; jj++)
                        {
                            ...
                            result += (tmp->data[k][ii][jj] * f->data[k][ii][jj]);
                        }
                    }
...
ip_mat * ip_mat_padding(ip_mat* a, unsigned int pad_h, unsigned int pad_w)
{
    if(a!=NULL){
        ...
        printf("Errore input ip_mat_padding!!!\n");
        exit(1);
    }
}
